    ...
    <>
      ...
      <div>
        <div className="flex  flex-wrap  w-[80% ] h-[33rem] m-20  border-solid border-2  border-black ">
          <div className="w-[100%] text-center text-[35px] h-5  text-indigo-800  font-bold font-['Inter']">
          ...
          <div className="w-[60%] mt-5 h-[35%] border-2">
            <p>Escreva sua bio:</p>
            <input className="w-[100%] h-[80%]  rounded-[25px] border-2 border-black" type="text" />
          </div>


          <div className="w-[30%] mt-10 h-[35%] border-2 ml-5 text-center mr-3">
          ...
          <div className=" w-full space-x-[50rem]  text-lg">
            <Link href="/">
              <Button class="border-2 ml-10 pl-8 pr-8 border-black rounded-2xl mr-11 text-black active:bg-[#150190] active:text-[white]" titulo="Voltar" />
            </Link>
            <Link href="/perfil">
